function calcAmt() {
  ...
  if (isNaN(a) || isNaN(b) || b <= 0) {
    ...
    document.getElementById("cost-per-person").innerHTML = `Cost per person is ₹ ${formattedResult}`;
...
function resetFields() {
  document.getElementById("amount").value = "";
  document.getElementById("people").value = "";
  document.getElementById("cost-per-person").textContent = "Please Enter the Amount";
}
